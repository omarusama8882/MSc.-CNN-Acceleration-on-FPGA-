...
HD_PWD='C:/Users/HP/Desktop/MSc.-CNN-Acceleration-on-FPGA-/RTL Inference Model/Mobilenetv1 Lite.runs/DenseWeights_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DenseWeights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DenseWeights.tcl
