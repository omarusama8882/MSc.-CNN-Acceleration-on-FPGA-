...
HD_PWD='C:/Users/HP/Desktop/MSc.-CNN-Acceleration-on-FPGA-/RTL Inference Model/Mobilenetv1 Lite.runs/c_addsub_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_8.tcl
