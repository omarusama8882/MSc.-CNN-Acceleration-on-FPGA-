...
#
# Generated by export_simulation on Wed Aug 21 15:29:57 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './c_addsub_9.sh' script.

./c_addsub_9.sh -reset_run
...
./c_addsub_9.sh -noclean_files

For more information on the script, please type './c_addsub_9.sh -help'.
