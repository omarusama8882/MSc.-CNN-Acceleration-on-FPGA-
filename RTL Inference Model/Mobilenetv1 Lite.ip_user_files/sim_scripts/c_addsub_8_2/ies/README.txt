...
#
# Generated by export_simulation on Wed Aug 21 15:27:50 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './c_addsub_8.sh' script.

./c_addsub_8.sh -reset_run
...
./c_addsub_8.sh -noclean_files

For more information on the script, please type './c_addsub_8.sh -help'.
